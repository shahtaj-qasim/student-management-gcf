...
public class DeleteStudentTest {
    ...
    private static final String FUNCTION_DEPLOYED_NAME = "DeleteStudent";
    ...
    @Test
    public void deleteStudent_Test() throws IOException, InterruptedException {
        ...
        assertThat(response.body().toString()).isEqualTo("STUDENT DELETED");
    }
}